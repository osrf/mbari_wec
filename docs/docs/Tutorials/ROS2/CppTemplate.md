...
[C++ examples](https://github.com/osrf/mbari_wec_utils/tree/release/v2.0.0/buoy_api_cpp/examples) and
[Python examples](https://github.com/osrf/mbari_wec_utils/tree/release/v2.0.0/buoy_api_py/buoy_api/examples) for
